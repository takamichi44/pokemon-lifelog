...
import { MichibaChat } from "./MichibaChat";
...
export function TrainerView({
  ...
  const [michibaChatOpen, setMichibaChatOpen] = useState(false);
    ...
    <div className="trainer-view">
      ...
      <section className="trainer-section">
        ...
        <div className="trainer-stats">
          ...
          <div className="trainer-stat">
            <span className="trainer-stat__val">
      ...
      {michibaChatOpen ? (
        <MichibaChat state={state} onClose={() => setMichibaChatOpen(false)} />
      ) : (
        <section className="trainer-section">
          <div className="trainer-section__title">ミチバ博士に質問</div>
          <div className="trainer-michiba-card">
            <div className="trainer-michiba-card__body">
              <div className="trainer-michiba-card__title">
                博士にこのアプリの仕様を尋ねる
              </div>
              <p className="trainer-michiba-card__desc">
                ミチバ博士がポケモンライフログの使い方、DP/TP、進化、バッジなどについて丁寧に答えてくれます。
              </p>
              <button
                className="trainer-michiba-card__button"
                onClick={() => setMichibaChatOpen(true)}
              >
                質問をはじめる
              </button>
            </div>
            ...
            <div className="dev-panel">
              ...
              <div className="dev-panel__row">
                ...
                <select
                  ...
                  value={devAttr}
                  onChange={(e) =>
                    setDevAttr(e.target.value as AttributeType | "all")
                  }
                >
              ...
              <div className="dev-panel__row">
                ...
                <input
                  ...
                  value={devAmount}
                  onChange={(e) =>
                    setDevAmount(Math.max(1, parseInt(e.target.value) || 1))
                  }
                />
              </div>
